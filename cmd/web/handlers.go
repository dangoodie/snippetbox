...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if id == 0 {
		app.serverError(w, r, errors.New("cannot find authenticatedUserID in context"))
	}
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			data := app.newTemplateData(r)
			form.AddFieldError("currentPassword", "Passwords do not match")
			data.Form = form
			app.render(w, r, http.StatusUnprocessableEntity, "password.tmpl", data)
		} else {
			app.serverError(w, r, err)
	...
	app.sessionManager.Put(r.Context(), "flash", "You have successfully changed your password!")
